      ...
      <View>
        ...
        <View style={[styles.card_container,styles.car_container_bgGreen]}>
          <View style={{flexDirection: 'row'}}>
            ...
            <View>
              <Text style={[styles.bankLink,styles.circletcktext_white]}>Transfer</Text>
              <View style={styles.othertext_content}>
                <Text style={[styles.othertext_contents,styles.circletcktext_white]}>Yesterday</Text>
              </View>
            </View>
          </View>
          <View style={styles.circletck}>
            {/* <CheckCircle /> */}
            <Text style={[styles.circletcktext,styles.circletcktext_white]}>- $ 85.00</Text>
          </View>
        </View>
